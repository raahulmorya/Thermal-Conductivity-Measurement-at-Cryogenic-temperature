...
// float sampleThickness = 20.0;    // Default value in mm
// float crossSectionArea = 100.0;  // Default value in mm²+
// float dT = 0.00;
...
//   const long interval = 5000;  // 5 second interval to send data
...
// void handleRoot() {
//     if (server.hasArg("thickness") && server.hasArg("area") && server.hasArg("temperatureoffset")) {
//     sampleThickness = server.arg("thickness").toFloat();
//     crossSectionArea = server.arg("area").toFloat();
...
//   html.replace("%AREA%", String(crossSectionArea));
